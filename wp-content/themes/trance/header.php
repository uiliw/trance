...
<div class="hfeed site" id="page">
    <div class="background-header">
            <!-- ******************* The Navbar Area ******************* -->
            <div class="wrapper-top-navbar" id="wrapper-top-navbar">

                <div class="container d-flex align-items-center">
                <a class="skip-link screen-reader-text sr-only" href="#content"><?php esc_html_e('Skip to content',
                        'trance'); ?></a>

                <ul class="mr-auto d-flex align-items-center">
                    <li><a href="#" title="<?php echo __('Portuguese', 'trance') ?>"><img
                                src="<?php echo get_template_directory_uri() ?>/img/flag-brazil.png"
                                alt="<?php echo __('Portuguese', 'trance') ?>" data-rjs="2"> </a></li>
                    <li><a href="#" title="<?php echo __('English', 'trance') ?>"><img
                                src="<?php echo get_template_directory_uri() ?>/img/flag-usa.png"
                                alt="<?php echo __('English', 'trance') ?>" data-rjs="2"> </a></li>
                    <li><a href="#" title="<?php echo __('Spanish', 'trance') ?>"><img
                                src="<?php echo get_template_directory_uri() ?>/img/flag-spain.png"
                                alt="<?php echo __('Spanish', 'trance') ?>" data-rjs="2"> </a></li>
                </ul>
                <ul class="ml-auto d-flex align-items-center">
                    ...
                    <li class="social"><a href="#" class="btn-face"
                                          title="<?php echo __('Facebook Oficial', 'trance') ?>"><i
                                class="fa fa-facebook"></i> </a></li>
                    <li class="social"><a href="#" class="btn-insta"
                                          title="<?php echo __('Instagram Oficial', 'trance') ?>"><i
        ...
        <?php endif; ?>
            ...
            <div class="dropdown profile">
                ...
                if (is_user_logged_in()) { ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-right animation slideUpIn"
                ...
                <?php } else { ?>
                    ...
                    <i class="fa fa-user-circle-o fa-2x" id="dropdownMenuButton" data-toggle="dropdown"
