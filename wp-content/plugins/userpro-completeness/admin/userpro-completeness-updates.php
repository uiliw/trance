...
if( !class_exists('WPUpdatesPluginUpdater_1462') ) {
    class WPUpdatesPluginUpdater_1462 {
		...
		if( !$userpro->verify_purchase( userpro_completeness_get_option('userpro_completeness_code'), '13z89fdcmr2ia646kphzg3bbz0jdpdja', 'DeluxeThemes', '14942712' ) ){
