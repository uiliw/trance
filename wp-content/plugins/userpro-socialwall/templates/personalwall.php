...
?>
<div class="title" id="walltitle"><?php echo 'Personal Social Wall '; ?></div>
...
<?php }?>
	<div class="buttonpost"><button type="submit"  name="Post_Now" value="Post Now" title="<?php _e('Add to Wall','userpro-userwall'); ?>" onclick="user_post_data('userpost',<?php echo get_current_user_id();?>,<?php echo $Personal_user_id;?> );"><i class="fa fa-send fa-fw"></i><b><?php _e('Add to Wall','userpro-userwall');?></b></button></div>
	<div class="upload" style="margin-top:0"><button class="userwall_upload"  data-filetype = 'photo' type="submit"  name="upload_image" value="upload" data-allowed_extensions=jpg,png,jpeg,gif title="<?php _e('Upload','userpro-userwall'); ?>"><i class="fa fa-image fa-fw"></i> <b><?php _e('Add Photos','userpro-userwall');?></b></button>
	</div><br>
