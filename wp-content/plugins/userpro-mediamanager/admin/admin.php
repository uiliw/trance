...
class userpro_media_admin {
	...
	function __construct() {
		...
		add_action('admin_enqueue_scripts', array(&$this, 'add_media_style'), 9);
	...
	function admin_init() {
		...
		$this->tabs = array(
			...
			'report' => __('Report','userpro-media'),
			'admin_approve' => __('Admin approve','userpro-media'),
			'instagram' => __('Instagram','userpro-media'),
		);
	...
	function add_media_style()
	{
		
		wp_register_script('admin_media_js', userpro_media_url . 'admin/scripts/admin_media.js');
		wp_enqueue_script('admin_media_js');

		wp_register_script('instagram_js', userpro_media_url . 'admin/scripts/instagram.js');
