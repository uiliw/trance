...
class MEC_gateway_stripe extends MEC_gateway
{
    ...
    ?>
        ...
        <div id="mec_gateways<?php echo $this->id(); ?>_container_toggle" class="<?php if((isset($this->options['status']) and !$this->options['status']) or !isset($this->options['status'])) echo 'mec-util-hidden'; ?>">
            <div class="mec-form-row">
