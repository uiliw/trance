...
class MEC_feature_events extends MEC_base
{
    ...
    public function init()
    {
        ...
        if(isset($this->settings['taxes_fees_status']) and $this->settings['taxes_fees_status']) $this->factory->action('mec_metabox_booking', array($this, 'meta_box_fees'), 15);
    ...
    ?>
        <div class="mec-meta-box-fields" id="mec-booking">
    ...
    ?>
        <div class="mec-meta-box-fields" id="mec-fees">
            ...
            <div class="mec-meta-box-fields" id="mec_meta_box_fees_form">
                <div class="mec-form-row">
                    <label>
