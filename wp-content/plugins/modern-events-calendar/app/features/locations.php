        ...
        <div class="mec-meta-box-fields" id="mec-location">
			...
			<div id="mec_location_new_container">
				...
				<div class="mec-form-row mec-thumbnail-row">
					...
					<button class="mec_location_upload_image_button button" id="mec_location_thumbnail_button"><?php echo __('Choose image', 'mec'); ?></button>
					<button class="mec_location_remove_image_button button mec-util-hidden"><?php echo __('Remove image', 'mec'); ?></button>
				</div>
			</div>
            <div class="mec-form-row">
