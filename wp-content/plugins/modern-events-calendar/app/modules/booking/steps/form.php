    ...
    <ul class="mec-book-tickets-container">
        ...
        <li class="mec-book-ticket-container">
            ...
            <div class="mec-reg-mandatory">
                ...
                <input id="mec_book_reg_field_name<?php echo $j; ?>" type="text" name="book[tickets][<?php echo $j; ?>][name]" value="" placeholder="<?php _e('Name', 'mec'); ?>" required />
            </div>
            <div class="mec-reg-mandatory">
                <label for="mec_book_reg_field_email<?php echo $j; ?>"><?php _e('Email', 'mec'); ?></label>
                <input id="mec_book_reg_field_email<?php echo $j; ?>" type="email" name="book[tickets][<?php echo $j; ?>][email]" value="" placeholder="<?php _e('Email', 'mec'); ?>" required />
            </div>
