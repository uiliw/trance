...
class MEC_factory extends MEC_base
{
    ...
    public function load_actions()
    {
        ...
        // MEC Set timezone
        $set_timezone = apply_filters('mec_set_timezone', true);
        if($set_timezone) $this->action('init', array($this->main, 'set_timezone'), 9999);
    ...
    public function load_backend_assets()
    {
        ...
        wp_enqueue_style('mec-backend-style', $this->main->asset('css/backend.css'));
        
        // Include "Right to Left" CSS file
        if(is_rtl()) wp_enqueue_style('mec-backend-rtl-style', $this->main->asset('css/rtlbackend.css'));
    }
    ...
    public function load_frontend_assets()
    {
        ...
        wp_enqueue_script('mec-events-script', $this->main->asset('js/events.js'));
        wp_enqueue_script('mec-flipcount-script', $this->main->asset('js/flipcount.js'));
        ...
        wp_enqueue_script('mec-richmarker-script', $this->main->asset('packages/richmarker/richmarker.min.js'));
        ...
        wp_enqueue_style('mec-owl-carousel-style', $this->main->asset('packages/owl-carousel/owl.carousel.css'));
        wp_enqueue_style('mec-owl-carousel-theme-style', $this->main->asset('packages/owl-carousel/owl.theme.css'));
        wp_enqueue_style('mec-font-icons', $this->main->asset('css/iconfonts.css'));
        wp_enqueue_style('mec-frontend-style', $this->main->asset('css/frontend.css'));
        
        // Include "Right to Left" CSS file
        if(is_rtl()) wp_enqueue_style('mec-frontend-rtl-style', $this->main->asset('css/mecrtl.css'));
