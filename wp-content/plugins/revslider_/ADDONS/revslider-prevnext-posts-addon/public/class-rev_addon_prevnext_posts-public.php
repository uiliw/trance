...
class Rev_addon_prevnext_posts_Public {
	...
	public function filter_print_posts($content) {
		...
		if( empty($rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-slider']) ) return $content;


		// Build Related Post Shortcode
		$prevnext_posts_shortcode = do_shortcode('[rev_slider alias="'.$rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-slider'].'"]');
		...
		if( !empty($rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-position']) && $rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-position'] == 'top' ){
	...
	public function get_prevnext_posts($rev_slider_addon_values,$post_type){
		...
		$in_same_term = !empty($rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-taxonomy-only']) && !empty($rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-taxonomy']) ? true : false;
		$taxonomy = $in_same_term ? $rev_slider_addon_values['rs-addon-prevnext-'.$post_type.'-taxonomy'] : '';
