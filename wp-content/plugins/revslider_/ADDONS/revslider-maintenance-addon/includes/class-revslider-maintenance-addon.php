...
class Revslider_Maintenance_Addon {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Revslider_Maintenance_Addon_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_save_maintenance', $plugin_admin, 'save_maintenance');

		//placeholders for timer
	 ...
	 *
	 * @since     1.0.0
	 * @return    Revslider_Maintenance_Addon_Loader    Orchestrates the hooks of the plugin.
	 */
