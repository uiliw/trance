...
class Rev_addon_rel_posts {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_save_rel_posts', $plugin_admin, 'save_rel_posts');
		$this->loader->add_action( 'wp_ajax_nopriv_save_rel_posts', $plugin_admin, 'save_rel_posts' );
